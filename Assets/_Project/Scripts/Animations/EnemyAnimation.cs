...
public class EnemyAnimation : MonoBehaviour
{
    ...
    private void Update()
    {
        //if (!_ec || !_anim || !_rb) return;

        //Vector3 dir = _ec.GetDirection(); // prendi direzione del player
        //bool moving = dir.magnitude > 0.01f; // si sta muovendo ????

        //bool grounded = _ec.isGrounded; // E' A TERRA ???
        ...
        //    if (shouldFall != _isFalling)
        //    {
        //        _isFalling = shouldFall;
        //        _anim.SetBool(_fallBool, _isFalling);
        //    }
        //}
        //else
        //{
