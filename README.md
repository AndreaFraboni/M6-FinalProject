M6 Final Project is a Refactoring on M4 Final Project :

- OnHealthChanged & OnDeathed Actions implemented in LifeController to control relatives UI
...
- Skybox added with enviroment setted to use skybox light and fake sun added
